...
/* Keep header transparent (not hidden) so the sidebar collapse/expand
   toggle stays clickable, and force the toggle icon to a visible color
   against our dark theme. Covers multiple Streamlit version testids. */
header {
...
input:-webkit-autofill:active {
    -webkit-text-fill-color: var(--text-primary) !important;
    -webkit-box-shadow: 0 0 0px 1000px rgba(20, 17, 42, 0.9) inset !important;
    box-shadow: 0 0 0px 1000px rgba(20, 17, 42, 0.9) inset !important;
